package com.therumbling.staymap.iam.infrastructure.authorization.sfs.configuration;

import com.therumbling.staymap.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.therumbling.staymap.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.therumbling.staymap.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class WebSecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(configurer -> configurer.configurationSource(awr -> {
