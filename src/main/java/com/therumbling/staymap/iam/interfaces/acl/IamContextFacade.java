package com.therumbling.staymap.iam.interfaces.acl;
...
public class IamContextFacade {
     ...
     */
    public Long createUser(String username, String password, Role role, String profileImage) {
        var signUpCommand = new SignUpCommand(username, password, role, profileImage);
